...
def make_merged_df(tickers):
    ...
    for ticker in tickers:
        dfs[ticker] = pd.read_csv(
            f"backtests/02_larry01/data/{ticker}.csv", index_col=0
        )
...
def main():
    ...
    for ticker in tickers:
        ...
        df.to_csv(f"backtests/02_larry01/data/{ticker}.csv")
    ...
    # Save final result
    merged_df.to_csv("backtests/02_larry01/data/merged_df.csv")
